...
public class FakeLoading {
    ...
    public static void fakeLoading(String loadingText, int delayInMilliSeconds, String textAndBackgroundColor) {//1000 milliseconds is 1 second, dus 50 seconden tot 100%
        String loadingBar = "";
